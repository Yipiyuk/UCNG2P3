...
\caption{Block diagram, showing the idea of PID controller.} \subcaption*{Credits: \url{www.wikipedia.org/wiki/PID_controller}}  
...
%\caption{Screenshot of the duty cycles on an oscilloscope.}  
 % \label{Duty cycles}
%\end{figure}
...
\caption{Screenshot of the C\#  TBD GUI used to monitor the sensor readings.}  
  \label{The GUI}
\end{figure}