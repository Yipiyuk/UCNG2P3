...
\caption{Block diagram, showing the idea of PID controller. Credits: \url{www.wikipedia.org/wiki/PID_controller}}  
...
\begin{figure}[h!]
  ...
  \caption{$K_p$ with 3 values. ($K_i$, $K_d$ held constant) Credits: \url{www.wikipedia.org/wiki/PID_controller}
  }
  \label{PID controller}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{$K_i$ shown with 3 values. Credits: \url{www.wikipedia.org/wiki/PID_controller}
  }
  \label{PID controller}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{$K_d$ shown with 3 values. Credits: \url{www.wikipedia.org/wiki/PID_controller}
  }
  \label{PID controller}
\end{figure}
...
TBD (Vores fremgangsmåde med PID alt efter om " THE D" skal bruges)
