...
\img{figures/sensorsonwhite.png}{Interface showing data sent with sensors placed over white surface}{guisensorsonwhite}{0.8}

\textbf{Sensors on black surface}
\img{figures/sensorsonblack.png}{Interface showing data sent with sensors placed over black surface}{guisensorsonblack}{0.8}
